...
function _dashBadgeTendencia(tipo){
  ...
  return '<span style="font-size:8px;font-weight:600;color:var(--tx3);margin-left:6px;cursor:default" title="'+tip+'">'+txt+'</span>';
}
