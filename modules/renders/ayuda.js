...
window.renderAyuda=function(){
  ...
  $('s-ayuda').innerHTML=
    ...
    '<p style="font-size:12px;color:var(--tx2);margin:10px 0">Nuevo reporte "Dotación de Taller" en Predictivo (¿alcanza el personal actual?, con tendencia y proyección a futuro) y el mismo método aplicado por ítem en Stock Filtros/Lubricantes/Repuestos (¿cuándo debo comprar?).</p>'+
    ...
    '<b>📈 Tendencia y Proyección de Compra:</b> botón nuevo en cada fila de Stock Filtros, Lubricantes y Control de Repuestos. Muestra el historial real de consumo/compra de ESE ítem por Mes/Semestre/Año, y proyecta con el promedio de los últimos meses: cuántos meses de cobertura queda el stock actual, en qué mes se agotaría, y la fecha sugerida para pedir (restando el lead time). En Filtros/Lubricantes usa el consumo real registrado; en Repuestos usa las Órdenes de Compra reales — si el ítem no tiene ninguna todavía, avisa que falta historial en vez de inventar un número.</div></div>'+
