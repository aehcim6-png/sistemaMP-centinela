...
window.renderAyuda=function(){
  ...
  $('s-ayuda').innerHTML=
    ...
    '<p style="font-size:12px;color:var(--tx2);margin:10px 0">Nuevo reporte "Dotación de Taller" en Predictivo (¿alcanza el personal actual?, con tendencia y proyección a futuro), el mismo método aplicado por ítem en Stock Filtros/Lubricantes/Repuestos (¿cuándo debo comprar?, ahora con gráfico), y en Neumáticos la misma pregunta a nivel de flota (¿cuántos voy a necesitar hasta fin de año?).</p>'+
