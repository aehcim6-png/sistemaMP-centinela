...
window.renderAyuda=function(){
  ...
  $('s-ayuda').innerHTML=
    ...
    '<li><b>Mejor clasificación de correctivos por componente:</b> el campo "componente" viene vacío en casi todos los correctivos reales — el sistema lo deriva del texto libre de "síntoma" que sí escribe el técnico. Se amplió ese diccionario en 3 pasadas con evidencia real (medida contra los 1.243 correctivos reales: subió de 42% a 59.7% de cobertura) — ahora reconoce, por ejemplo, "falla eléctrica" (antes solo "falla eléctrico"), presión de neumáticos sin decir la palabra "neumático" (incluyendo el verbo conjugado, no solo el sustantivo), "suspencion" con "c", cañerías y flexibles como Mangueras/Fugas, y separa Engrase/Lubricación, Fuga de Aceite, Radio/Comunicaciones y Tornamesa/Giro como categorías propias. Términos sin ninguna evidencia real en la base (ej. "lainas", "bomba centrífuga") deliberadamente NO se agregaron — y términos que cruzan demasiados sistemas distintos (sensor, válvula) se dejaron sin clasificar en vez de forzarlos. Se ve reflejado en Estadística → Por Componente y en Predictivo (detección de fallas repetidas).</li>'+
    '</ul>'+
    '</div>'+
