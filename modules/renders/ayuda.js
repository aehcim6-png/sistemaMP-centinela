...
window.renderAyuda=function(){
  ...
  $('s-ayuda').innerHTML=
    ...
    '<p style="font-size:12px;color:var(--tx2);margin:10px 0">Nuevo reporte "Dotación de Taller" en Predictivo: responde si la dotación actual de técnicos alcanza para la carga de trabajo real, con tendencia histórica y proyección a futuro.</p>'+
