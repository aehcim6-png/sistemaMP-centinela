...
window.renderAyuda=function(){
  ...
  $('s-ayuda').innerHTML=
    ...
    '<tr><td><b><svg viewBox="0 0 20 20" width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"><polygon points="10,2.5 16,6 16,13 10,16.5 4,13 4,6"/><circle cx="10" cy="9.5" r="2.3"/></svg> Componentes</b></td><td>6 sub-pestañas</td><td>Componentes Mayores (motor/transmisión/diferencial/batería/etc., estado actual), Predictivo, Destrabe, Informes de Falla (genera PDF descargable), Tren de Rodaje (eslabones, bujes, zapatas, sprockets) e Historial de Componentes (cuánto duró cada reemplazo real)</td></tr>'+
