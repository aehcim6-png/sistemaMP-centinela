// Pestaña Metas & KPIs (contenedor con 4 sub-pestañas: Metas / Avance del
// Mes / Informes KPI / Resumen Ejecutivo) — extraída a su propio archivo
// (Fase 2 de modularización). Módulo ES real (Fase 3, 2026-08-30, cuarta
...
export function renderMkpi() {
  ...
  $('s-mkpi').innerHTML = `
    ...
    <div style="display:flex;gap:8px;margin-bottom:16px;flex-wrap:wrap">
      ...
      <button class="btn ${sub === 'resumen' ? '' : 'btn-o'}" onclick="mkpiSub('resumen')">${ICONS.doc} Resumen Ejecutivo</button>
    </div>
  ...
  else if (sub === 'resumen') renders.resumen();
