...
export function renderDisp(){
  ...
  if(fVista==='mensual'){
    ...
    var totalFlota=conDatos.length?Math.round(conDatos.reduce(function(s,e){return s+e.pct},0)/conDatos.length*10)/10:null;
  ...
  var fsEnCurso=equiposFueraDeServicioAhora(ot);
