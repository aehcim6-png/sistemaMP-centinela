...
Deno.test("validarImagenBase64: justo en el tope pasa (el rechazo es estrictamente mayor)", () => {
  const justo = "a".repeat(TOPE_IMAGEN_BASE64);
  assertEquals(validarImagenBase64({ imagenBase64: justo }), null);
});
